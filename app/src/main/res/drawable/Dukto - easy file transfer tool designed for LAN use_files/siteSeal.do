...
function ss_open_sub(){
  ...
  ss_url_p1          = "d6671a2f"
  ss_url_p2          = "6bee9bdc43b5e41388a8835e6ccc8fa9b17aaf2b2cb7ce8e5deca64695cc805e68d2cbb0ac64a8600fee9ad947afba54d5f3"
  ss_url_p3          = "5d752bbb122da997ccd916723c8b2971c54712b5"
...
function writeFlash() {
  ...
  var str =
    ...
    "<PARAM NAME='flashVars' VALUE='timeText=08:30:52(UTC)'>" +
    "<PARAM NAME='wmode' VALUE='transparent'>" +    
    "<EMBED src='" + ss_flashLocation + "' FlashVars='timeText=08:30:52(UTC)'" +
    " WIDTH='" + ss_width + "'" +
    " HEIGHT='" + ss_height + "'" +
    " NAME='ss_imgTag'" +
